...
public class BackCameraMovement extends AbstractInputAction {

	private ICamera camera;
	private MovementToggle m;
	public BackCameraMovement(ICamera c, MovementToggle t)
	{
		camera = c;
		m = t;
	...
	public void performAction(float timeElapsed, net.java.games.input.Event e)
	{
		...
		Vector3D newLoc = curLoc.minus(viewDir.mult(moveAmount));
